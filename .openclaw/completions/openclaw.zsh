...
_openclaw_message_send() {
  _arguments -C \
    ...
    "--channel[Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|nostr|msteams|mattermost|nextcloud-talk|feishu|matrix|bluebubbles|line|zalo|zalouser|tlon]" \
...
_openclaw_agent() {
  _arguments -C \
    ...
    "--channel[Delivery channel: last|telegram|whatsapp|discord|googlechat|slack|signal|imessage|nostr|msteams|mattermost|nextcloud-talk|feishu|matrix|bluebubbles|line|zalo|zalouser|tlon (default: whatsapp)]" \
...
_openclaw_cron_add() {
  _arguments -C \
    ...
    "--channel[Delivery channel (last|whatsapp|feishu)]" \
...
_openclaw_pairing_list() {
  _arguments -C \
    "--channel[Channel (whatsapp, feishu)]" \
    "--json[Print JSON]"
}
...
_openclaw_channels_capabilities() {
  _arguments -C \
    "--channel[Channel (all|telegram|whatsapp|discord|googlechat|slack|signal|imessage|nostr|msteams|mattermost|nextcloud-talk|feishu|matrix|bluebubbles|line|zalo|zalouser|tlon)]" \
